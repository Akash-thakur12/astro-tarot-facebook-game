...
Locator:  locator('span.text-mystic-gold.font-black.text-lg').first()
Expected: "40"
Received: "0"
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('span.text-mystic-gold.font-black.text-lg').first()
    9 × locator resolved to <span class="text-mystic-gold font-black text-lg">0</span>
      - unexpected value "0"
