  ...
  return (
    <div className="flex flex-col w-full min-h-screen pb-32 animate-fade-in bg-[#09090b] relative overflow-hidden font-sans">
      ...
      <div className="px-5 pt-8 space-y-6 relative z-10">
        ...
        {/* TOP HEADER: Identity & Coins */}
        <div className="relative z-[100] flex items-center justify-between bg-white/5 backdrop-blur-lg border border-white/10 p-4 rounded-[2.5rem] shadow-lg">
